...
//go:generate go run github.com/golang/mock/mockgen -package=table -destination=mock_test.go github.com/Ncog-Earth-Chain/forest-base/kvdb DBProducer,DropableStore
