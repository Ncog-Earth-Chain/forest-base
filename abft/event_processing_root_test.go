...
func TestForestClassicRoots(t *testing.T) {
...
func TestForestRandomRoots(t *testing.T) {
	// generated by codegen4ForestRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeForest(nodes, nil)
...
/*
// codegen4ForestRandomRoot is for test data generation.
func codegen4ForestRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeForest(nodes)
	// process events
	config := inter.Events{}
